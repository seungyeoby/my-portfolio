...
import { FindEmailRequest, FindEmailResponse, ResetPasswordRequest, LogoutResponse } from "../../types/index.js";
...
class AuthController {
  ...
  resetPassword = async (req: Request, res: Response): Promise<void> => {
    const { email, nickname, birthDate, newPassword }: ResetPasswordRequest = req.body;
